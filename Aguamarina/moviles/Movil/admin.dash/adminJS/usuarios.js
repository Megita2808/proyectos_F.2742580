function listarPersonas() {
    ...
    listaPersonas.forEach(function (usuario) {
        tablaPersonas.innerHTML += `
            <tr style="font-family: 'Montserrat', sans-serif;">
                ...
                <td>${persona.contresena}</td>
                <td>
                    <a class="btn btn-sm btn-success"  onclick="find(${persona.id})">
                        <i class="fa fa-edit"></i>
                    </a>
                </td>
                <td>
                    <button class="btn btn-sm btn-danger" onclick="removeData(${persona.id})">
...
function guardar(){
    ...
    if(correcto) {
        personaslist = JSON.parse(localStorage.getItem('productos')) ?? []
