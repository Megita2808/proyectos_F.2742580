...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-[#090E34] px-20 pt-20 lg:px-50 lg:pb-20">
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="flex w-full items-center px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            ...
            <p className="ml-6 w-[200px] text-base text-white">
              AguaMarina alquiler mobiliario
            </p>
          </div>

          <div className="flex w-full justify-between px-4 sm:w-1/2 md:w-1/2 lg:w-8/12 xl:w-9/12">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="mb-[20px] text-lg font-semibold text-white dark:text-white">
                  Estamos ubicados en:
                </h3>
                <p className="text-body-color text-base text-dark-6 dark:text-dark-6">
                  Cll 45c 20c-77
                  <br />
                  Medellín, barrio Buenos Aires
                </p>
              </div>
            </div>
            <div className="flex items-center">
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[30px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-white">
                  Diseñado & Desarrollado por <a>AguaMarina</a>
                </p>
              </div>
            </div>
          </div>
      ...
      <div>
        <span className="absolute left-0 top-0 z-[-1] aspect-[95/82] w-full max-w-[440px]">
