...
type SelectedImages = {
  [key: number]: number; // id del producto -> cantidad seleccionada
};
...
const SelectPerdida: React.FC<ImageCatalogProps> = ({ products }) => {
    ...
    <div className="flex flex-row gap-4">
      {products.map((product) => (
        <div
          ...
          style={{
            position: "relative",
            border: selectedImages[product.id_product] ? "3px solid #5057f1" : "1px solid gray",
            borderRadius: "8px",
            overflow: "hidden",
            cursor: "pointer",
            width: "120px",
        ...
        >
          <div onClick={() => handleSelect(product.id_product)}>
            ...
            <div
              style={{
                position: "absolute",
                color: selectedImages[product.id_product] ? "#5057f1" : "gray",
                top: "5px",
                right: "5px",
              }}
          ...
          <div style={{ marginTop: "10px", textAlign: "center" }}>
            <label>Cantidad total: {formatNumberWithCommas(product.disponibility)}</label>
            <label style={{ display: "block", marginBottom: "5px" }}>Cantidad dañada:</label>
            <input
              type="number"
              disabled={selectedImages[product.id_product] ? false : true}
              min={0}
              value={selectedImages[product.id_product]}
