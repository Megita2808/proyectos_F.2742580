...
const SwitcherProductsForm: React.FC<{id?: number | string, name: string, checked?: boolean,  onChange?: React.ChangeEventHandler<HTMLInputElement | HTMLTextAreaElement>;}> = ({id = "0", name, checked, onChange}) => {
    ...
    <div>
      ...
      >
        <div className="relative">
          ...
          />
          <div className="block h-8 w-20 rounded-full bg-gray-3 dark:bg-[#5A616B]"></div>
          <div
            className={`dot absolute left-1 top-1 flex h-6 w-9 items-center justify-center rounded-full hover:scale-125 duration-300  bg-red-400 text-white dark:text-dark shadow-switch-1 transition ${
              enabled && "!right-1 !translate-x-full !bg-green-400 dark:!bg-green-400"
            }`}
          >
...
export default SwitcherProductsForm;
